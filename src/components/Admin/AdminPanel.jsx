                  ...
                  <div className="space-y-12">
                    {!selectedEnquiry ? (
                      <>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-center bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm gap-8 relative overflow-hidden">
                           <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 rounded-full blur-2xl -mr-16 -mt-16" />
                           <div className="text-center md:text-left relative z-10">
                             <h3 className="font-fredoka text-4xl text-slate-800 tracking-tight mb-2">Lead Dashboard</h3>
                             <p className="text-slate-400 text-sm font-medium">You have <span className="text-primary font-bold">{content.enquiry?.submissions?.length || 0} enquiries</span> to review</p>
                           </div>
                           <div className="relative z-10">
                             <button 
                               onClick={() => {
                                 const headers = ['Name', 'Phone', 'Email', 'Program', 'Date', 'Status', 'Subject', 'Message', 'Notes'];
                                 const rows = content.enquiry?.submissions?.map(s => [
                                   s.name, s.phone, s.email, s.program, s.date, s.status, s.subject, s.message, s.remarks || ''
                                 ]);
                                 ...
                                 a.setAttribute('download', 'leads_full_data.csv');
                                 document.body.appendChild(a);
                                 a.click();
                                 document.body.removeChild(a);
                               }}
                               className="bg-slate-900 text-white px-10 py-4 rounded-full text-xs font-black tracking-widest shadow-xl hover:bg-primary hover:scale-[1.02] transition-all flex items-center gap-3 active:scale-95"
                             >
                               <Download className="w-5 h-5" /> EXPORT FULL DATA
                             </button>
                           </div>
                        </div>
                              ...
                              <table className="w-full text-left min-w-[800px]">
                                 <thead>
                                    <tr className="bg-slate-50/50 border-b border-slate-100">
                                       <th className="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] leading-none">Lead Information</th>
                                       <th className="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] leading-none text-center">Status</th>
                                       <th className="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] leading-none">Interest</th>
                                       <th className="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] leading-none">Date Received</th>
                                       <th className="px-10 py-6 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] leading-none text-right">Actions</th>
                                    </tr>
                                 </thead>
                                 <tbody className="divide-y divide-slate-50">
                                    {content.enquiry?.submissions?.map((sub, i) => (
                                       <tr 
                                          ...
                                          onClick={() => setSelectedEnquiry(sub)}
                                       >
                                          <td className="px-10 py-7">
                                             <div className="flex items-center gap-5">
                                                <div className="w-12 h-12 bg-slate-50 rounded-2xl flex items-center justify-center font-fredoka font-bold text-slate-400 text-lg group-hover:bg-primary/10 group-hover:text-primary transition-colors">
                                                   {i + 1}
                                                </div>
                                                <div>
                                                   <p className="font-fredoka text-xl text-slate-800 group-hover:text-primary transition-colors leading-tight mb-1">{sub.name}</p>
                                                   <p className="text-[11px] text-slate-400 font-bold uppercase tracking-widest">{sub.phone}</p>
                                                </div>
                                             </div>
                                          </td>
                                          <td className="px-10 py-7 text-center">
                                             <span className={`inline-block px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest ${
                                                sub.status === 'New' ? 'bg-blue-50 text-blue-600' :
                                                sub.status === 'In Progress' ? 'bg-yellow-50 text-yellow-700' :
                                          ...
                                          <td className="px-10 py-7">
                                             <span className="text-[12px] font-bold text-slate-600 bg-slate-100 px-3 py-1.5 rounded-xl">
                                                {sub.program}
                                             </span>
                                          </td>
                                          <td className="px-10 py-7">
                                             <span className="text-[11px] text-slate-400 font-bold uppercase tracking-widest">{sub.date}</span>
                                          </td>
                                          <td className="px-10 py-7 text-right">
                                             <div className="flex items-center justify-end gap-3 opacity-0 group-hover:opacity-100 transition-all">
                                                <button className="px-5 py-2.5 bg-slate-900 text-white rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-primary transition-all">
                                                   VIEW DETAILS
                                                </button>
                                             </div>
                                          </td>
                        ...
                        {/* Extra Settings Grid below the list */}
                        <div className="grid grid-cols-1 xl:grid-cols-3 gap-12 pt-12 border-t border-slate-100">
                          <div className="xl:col-span-1">
                             <div className="bg-primary/5 p-8 rounded-[3rem] border border-primary/10">
                                <h4 className="font-fredoka text-xl text-primary mb-2">Campaign Settings</h4>
                                <p className="text-slate-400 text-xs">Manage the contact detail and visuals for your inbound capture pages.</p>
                             </div>
                          </div>
                      ...
                      <div className="animate-in fade-in slide-in-from-bottom-5 duration-500 space-y-10">
                         ...
                         <div className="flex items-center justify-between">
                            <button 
                               ...
                               className="flex items-center gap-3 text-slate-400 hover:text-primary transition-all font-bold text-xs uppercase tracking-widest group"
                            >
                               <div className="w-10 h-10 bg-white border border-slate-100 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform"><X className="w-4 h-4" /></div>
                               BACK TO LEADS
                            </button>
                            <div className="flex items-center gap-4">
                               <span className={`px-5 py-2 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm ${
                                  selectedEnquiry.status === 'New' ? 'bg-blue-50 text-blue-600' :
                                  selectedEnquiry.status === 'In Progress' ? 'bg-yellow-50 text-yellow-700' :
                                  'bg-green-50 text-green-600'
                               }`}>
                         ...
                         <div className="bg-white rounded-[4rem] border border-slate-100 shadow-xl overflow-hidden min-h-[70vh] flex flex-col">
                            {/* Detailed Content */}
                            <div className="p-12 lg:p-20 flex-1 space-y-20">
                               <div className="flex flex-col lg:flex-row justify-between items-start gap-12">
                                  <div className="space-y-4">
                                     <h3 className="font-fredoka text-7xl text-slate-900 leading-[1.1] tracking-tight">{selectedEnquiry.name}</h3>
                                     <div className="flex flex-wrap items-center gap-6">
                                        <div className="bg-primary/10 text-primary px-6 py-2 rounded-2xl font-fredoka text-2xl">{selectedEnquiry.program}</div>
                                        <div className="text-slate-300 text-2xl">•</div>
                                        <div className="text-slate-400 font-black text-xs uppercase tracking-[0.2em]">{selectedEnquiry.date}</div>
                                     </div>
                                  </div>
                                  <div className="flex flex-col gap-4 w-full lg:w-96">
                                     <div className="p-8 bg-slate-50/50 border border-slate-100 rounded-[2.5rem] group hover:bg-primary/5 transition-all">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest block mb-4">Quick Contact</label>
                                        <p className="font-fredoka text-3xl text-slate-800 mb-6">{selectedEnquiry.phone}</p>
                                        <button 
                                           onClick={() => {
                                              navigator.clipboard.writeText(selectedEnquiry.phone);
                                              alert('Copied!');
                                           }}
                                           className="w-full py-4 bg-white border border-slate-200 text-[10px] font-black text-slate-500 rounded-2xl hover:text-primary hover:border-primary transition-all uppercase tracking-widest"
                                        >
                                           COPY PHONE NUMBER
                                        </button>
                                     </div>
                               ...
                               <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
                                  <div className="space-y-10">
                                     <div className="space-y-6">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] block pl-1">Parent's Inquiry</label>
                                        <div className="p-10 bg-slate-900 rounded-[3rem] text-white relative overflow-hidden">
                                           <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full blur-3xl -mr-16 -mt-16" />
                                           <h4 className="font-fredoka text-3xl mb-6 relative z-10 leading-tight">{selectedEnquiry.subject}</h4>
                                           <p className="text-xl text-white/60 font-medium italic relative z-10 leading-relaxed">
                                  ...
                                  <div className="space-y-10">
                                     <div className="space-y-6">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] block pl-1">Status Management</label>
                                        <select
                                           className={`w-full p-8 h-24 rounded-[3rem] text-xl font-fredoka font-bold outline-none border-2 transition-all cursor-pointer shadow-sm ${
                                             selectedEnquiry.status === 'New' ? 'bg-blue-50 border-blue-100 text-blue-600' :
                                             selectedEnquiry.status === 'In Progress' ? 'bg-yellow-50 border-yellow-100 text-yellow-700' :
                                             'bg-green-50 border-green-100 text-green-600'
                                           }`}
                                           value={selectedEnquiry.status}
                                           onChange={(e) => {
                                              const newS = content.enquiry.submissions.map(s => s.id === selectedEnquiry.id ? {...s, status: e.target.value} : s);
                                              setContent(prev => ({ ...prev, enquiry: { ...prev.enquiry, submissions: newS } }));
                                              setSelectedEnquiry({...selectedEnquiry, status: e.target.value});
                                           }}
                                        >
                                           <option value="New">Status: New Enquiry</option>
                                           <option value="In Progress">Status: Contacted</option>
                                           <option value="Enrolled">Status: Enrolled</option>
                                        </select>
                                     </div>

                                     <div className="space-y-6">
                                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.3em] block pl-1">Internal Remarks</label>
                                        <textarea
                                           className="w-full bg-slate-50/50 border border-slate-100 focus:border-primary/20 rounded-[3rem] p-10 text-lg text-slate-600 outline-none h-64 transition-all resize-none shadow-inner"
                                           placeholder="Type notes from your conversation here..."
                                           value={selectedEnquiry.remarks || ''}
                                           onChange={(e) => {
                                              const newS = content.enquiry.submissions.map(s => s.id === selectedEnquiry.id ? {...s, remarks: e.target.value} : s);
                                              setContent(prev => ({ ...prev, enquiry: { ...prev.enquiry, submissions: newS } }));
                                              setSelectedEnquiry({...selectedEnquiry, remarks: e.target.value});
                                           }}
                                        />
                                     </div>
                                  </div>
                            ...
                            {/* Sticky Footer for Detail View */}
                            <div className="p-12 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                               <button 
                                  onClick={() => setSelectedEnquiry(null)}
                                  className="px-12 py-6 bg-slate-900 text-white rounded-full font-black text-xs uppercase tracking-[0.2em] hover:bg-primary transition-all shadow-xl"
                               >
                                  DONE REVIEWING
                               </button>
                               <button 
                                  onClick={() => {
                                     if(confirm('Are you absolutely sure? This will delete the lead forever.')) {
                                        const newS = content.enquiry.submissions.filter(s => s.id !== selectedEnquiry.id);
                                        setContent(prev => ({ ...prev, enquiry: { ...prev.enquiry, submissions: newS } }));
                                        setSelectedEnquiry(null);
                                     }
                                  }}
                                  className="px-8 py-6 text-red-500 font-bold text-xs uppercase tracking-widest hover:text-red-700 transition-colors"
                               >
                                  DELETE LEAD FOREVER
                               </button>
                            </div>
